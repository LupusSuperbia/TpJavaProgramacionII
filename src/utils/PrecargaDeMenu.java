...
public class PrecargaDeMenu {
	...
	public void precargarDatos(AdministradorProveedor adminProv , AdministradorUsuario adminClien, AdministradorServicio adminServicio) {
		...
		ProveedorServicio<ServicioDomestico> pServicio1 = new ProveedorServicio<>("Juana", "Soy muy proactiva me gusta el trato con los niños, me gusta trabajar con niños de 5 a 8 años ", "000051023053", 2500, servicioDomestico4);
		ProveedorServicio<ServicioDomestico> pServicio2 = new ProveedorServicio<>("Martin", "Me encanta la jardineria, llevo en el campo desde que soy chico ya que es un ingreso extra y soy muy detallista", "005123051234", 2500, servicioDomestico3);
		ProveedorServicio<ServicioSalud> pServicio3 = new ProveedorServicio<>("Luciana", "Estudiante de enfermeria, hice un curso para aplicar inyectables", "051234123", 2500, servicioSalud1);
		ProveedorServicio<ServicioSalud> pServicio4 = new ProveedorServicio<>("Giuliana", "Estudiante de enfermeria, tengo 2 años de experiencia en cuidado de enfermos", "05123512366", 2500, servicioSalud);
